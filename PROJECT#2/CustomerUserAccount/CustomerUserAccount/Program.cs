...
namespace CustomerUserAccount
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Default Object
            CustomerUserAccount objAccount1 = CustomerUserAccount.GetInstance();
            // Parameterized Object
            CustomerUserAccount objAccount2 = CustomerUserAccount.GetInstance("Joe","111","joe@comp1.com");
            ...
            CustomerUserAccount.GetInstance();
            CustomerUserAccount.GetInstance("Test", "Pass", "Emai");
            Console.WriteLine();

            // Testing Authenticate(U,P) Method 
            Console.WriteLine("Calling objAccount2 Authenticate() method with correct data = Joe & 111");
            Console.WriteLine(objAccount2.Authenticate("Joe", "111"));

            Console.WriteLine("Calling objAccount2 Authenticate() method with wrong data = Mary & 3454345");
